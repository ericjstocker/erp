...
export const api = {
  ...
  listArchivedCustomers: () => request('/customers/archived'),
  ...
  archiveCustomer: (id) => request(`/customers/${id}/archive`, { method: 'PATCH' }),
  restoreCustomer: (id) => request(`/customers/${id}/restore`, { method: 'PATCH' }),
  deleteCustomer: (id) => request(`/customers/${id}`, { method: 'DELETE' }),
  updateMaterial: (id, body) => request(`/materials/${id}`, { method: 'PUT', body: JSON.stringify(body) }),
  listJobs: () => request('/jobs'),
  listArchivedJobs: () => request('/jobs/archived'),
  ...
  archiveJob: (id) => request(`/jobs/${id}/archive`, { method: 'PATCH' }),
  restoreJob: (id) => request(`/jobs/${id}/restore`, { method: 'PATCH' }),
  deleteJob: (id) => request(`/jobs/${id}`, { method: 'DELETE' }),
  listParts: () => request('/parts'),
  listArchivedParts: () => request('/parts/archived'),
  ...
  archivePart: (id) => request(`/parts/${id}/archive`, { method: 'PATCH' }),
  restorePart: (id) => request(`/parts/${id}/restore`, { method: 'PATCH' }),
